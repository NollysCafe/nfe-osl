...
export default [
	{
		version: 'v1.0',
		releaseDate: new Date('2025-03-08'),
		description: `Initial stable release of the Nolly's Fair & Ethical Open-Source License (NFE-OSL v1.0), an independent license focused on ethical usage, attribution, and fair contribution.`,
...
- If this software is used to train AI models or process large datasets, the resulting models or datasets **must be open-sourced** under the same NFE-OSL v1.0 terms.
