...
1. Open License Foundation
This software is licensed under Nolly's Fair & Ethical Open-Source License (NFE-OSL v1.0), which guarantees open-source freedoms while enforcing attribution, fair commercial use, and ethical limitations. It is an independent, custom license not derived from any OSI-approved license.
...
Failure to request commercial permission will result in license termination.` : `Commercial use is restricted under this license.
To use this software commercially, you must:
- Contact the author
- Obtain explicit permission for commercial use.

Unauthorized commercial use terminates this license immediately.`}
...
${aiUsage ? `- If this software is used to train AI models or process large datasets, the resulting models or datasets **must be open-sourced** under the same NFE-OSL v1.0 terms.
...
The author (${name}) reserves the right to enforce these terms through legal means.

7. Future-Proofing & Legal Validity
- This license applies indefinitely (including all future versions of this software).
- It is legally binding under **EU copyright law**
...
> This license is not OSI-approved and is not derived from any OSI-approved license.
> It is designed for ethical, open collaboration.
`
}
